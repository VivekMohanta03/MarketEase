      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at marketease.business@gmail.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                marketease.business@gmail.com, or by calling us at +91
                12334567890 between the business hours of 9am and 5pm IST,
                Monday to Friday.
              </p>
            </div>
          )}
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Currently, we only offer shipping within India only.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept Visa, Mastercard, Paypal payment method. You can also
                pay through cash on delivery as per your convenience.
              </p>
            </div>
          )}
        </div>
